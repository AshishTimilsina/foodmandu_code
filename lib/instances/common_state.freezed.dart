...
abstract class $CommonStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoad, bool isError, bool isSuccess, String errmessage});
}
...
class _$_CommonState implements _CommonState {
  ...
  @override
  String toString() {
    return 'CommonState(isLoad: $isLoad, isError: $isError, isSuccess: $isSuccess, errmessage: $errmessage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, isLoad, isError, isSuccess, errmessage);
...
abstract class _CommonState implements CommonState {
  const factory _CommonState(
      ...
      required final String errmessage}) = _$_CommonState;
