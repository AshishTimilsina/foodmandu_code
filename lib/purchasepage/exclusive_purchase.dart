...
class Exclusivepurchase extends ConsumerStatefulWidget {
  const Exclusivepurchase({super.key, required this.exclusivefoodata});
  final Exclusive exclusivefoodata;

  @override
  ConsumerState<Exclusivepurchase> createState() => _ExclusivepurchaseState();
}

class _ExclusivepurchaseState extends ConsumerState<Exclusivepurchase> {
                      ...
                      return Column(
                        children: [
                          SizedBox(
                            ...
                            child: Image(
                              image: AssetImage(
                                  widget.exclusivefoodata.foodimages),
                              fit: BoxFit.cover,
                            ),
                          ),
                          ListTile(
                            ...
                            title: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    widget.exclusivefoodata.fooditem,
                                    style: const TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 16),
                                  ),
                                  Text(
                                    widget.exclusivefoodata.location,
                                  ),
                                  Text(widget.exclusivefoodata.resname),
                                ],
                              ),
                            ),
                          ),
              ...
              Padding(
                  ...
                  child: Form(
                    ...
                    child: Column(
                        ...
                        children: [
                          Text(
                            widget.exclusivefoodata.amount,
                            style: const TextStyle(
                              fontSize: 20,
                            ...
                            onTap: () {
                              ...
                              if (_form.currentState!.validate()) {
                                ref.read(orderprovider.notifier).addorder(
                                      ...
                                      amount: widget.exclusivefoodata.amount,
