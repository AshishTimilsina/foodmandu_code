...
class Veganpurchase extends ConsumerStatefulWidget {
  const Veganpurchase({super.key, required this.vegandata});
  final Vegan vegandata;

  @override
  ConsumerState<Veganpurchase> createState() => _VeganpurchaseState();
}

class _VeganpurchaseState extends ConsumerState<Veganpurchase> {
                      ...
                      return Column(
                        children: [
                          SizedBox(
                            ...
                            child: Image(
                              image: NetworkImage(widget.vegandata.image),
                              fit: BoxFit.cover,
                            ),
                          ),
                          ListTile(
