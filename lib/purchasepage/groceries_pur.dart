...
class Groceriespurchase extends ConsumerStatefulWidget {
  const Groceriespurchase({super.key, required this.groceries});
  final Grocery groceries;

  @override
  ConsumerState<Groceriespurchase> createState() => _GroceriespurchaseState();
}

class _GroceriespurchaseState extends ConsumerState<Groceriespurchase> {
                      ...
                      return Column(
                        children: [
                          SizedBox(
                            ...
                            child: Image(
                              image: NetworkImage(widget.groceries.image),
                              fit: BoxFit.cover,
                            ),
                          ),
                          ListTile(
