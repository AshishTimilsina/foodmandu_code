...
class RestaurantPurchase extends ConsumerStatefulWidget {
  const RestaurantPurchase(
      {super.key,
      required this.resimage,
      required this.resname,
      required this.fooditem,
      required this.deliveryhrs,
      required this.fname,
      required this.location});
  final String resimage;
  final String resname;
  final String fooditem;
  final String deliveryhrs;
  final String location;
  final String fname;

  @override
  ConsumerState<RestaurantPurchase> createState() => _RestaurantPurchaseState();
}

class _RestaurantPurchaseState extends ConsumerState<RestaurantPurchase> {
                      ...
                      return Column(
                        children: [
                          SizedBox(
                            ...
                            child: Image(
                              image: AssetImage(widget.fooditem),
                              fit: BoxFit.cover,
                            ),
                          ),
                          ListTile(
                            ...
                            leading: Row(
                              ...
                              children: [
                                Image(image: AssetImage(widget.resimage)),
