...
class Cakepurchase extends ConsumerStatefulWidget {
  const Cakepurchase({
    super.key,
    required this.img,
    required this.title,
  ...
  @override
  ConsumerState<Cakepurchase> createState() => _CakepurchaseState();
}

class _CakepurchaseState extends ConsumerState<Cakepurchase> {
