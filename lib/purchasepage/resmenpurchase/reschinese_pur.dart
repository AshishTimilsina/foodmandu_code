...
class Chinesepurchase extends ConsumerStatefulWidget {
  const Chinesepurchase({
    super.key,
    required this.img,
    required this.title,
    required this.price,
  ...
  @override
  ConsumerState<Chinesepurchase> createState() => _ChinesepurchaseState();
}

class _ChinesepurchaseState extends ConsumerState<Chinesepurchase> {
