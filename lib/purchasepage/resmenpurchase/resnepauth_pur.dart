...
class NepaliAuthpurchase extends ConsumerStatefulWidget {
  const NepaliAuthpurchase({
    super.key,
    required this.img,
    required this.title,
    required this.price,
  ...
  @override
  ConsumerState<NepaliAuthpurchase> createState() => _NepaliAuthpurchaseState();
}

class _NepaliAuthpurchaseState extends ConsumerState<NepaliAuthpurchase> {
