...
class Burgerpurchase extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<Burgerpurchase> createState() => _BurgerpurchaseState();
}

class _BurgerpurchaseState extends ConsumerState<Burgerpurchase> {
