...
class Indianpurchase extends ConsumerStatefulWidget {
  const Indianpurchase({
    super.key,
    required this.img,
    required this.title,
    required this.price,
  ...
  @override
  ConsumerState<Indianpurchase> createState() => _IndianpurchaseState();
}

class _IndianpurchaseState extends ConsumerState<Indianpurchase> {
