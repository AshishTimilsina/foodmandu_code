...
class Platterpurchase extends ConsumerStatefulWidget {
  const Platterpurchase({
    super.key,
    required this.img,
    required this.title,
    required this.price,
  ...
  @override
  ConsumerState<Platterpurchase> createState() => _PlatterpurchaseState();
}

class _PlatterpurchaseState extends ConsumerState<Platterpurchase> {
