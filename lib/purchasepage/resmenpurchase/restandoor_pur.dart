...
class Tandoorpurchase extends ConsumerStatefulWidget {
  const Tandoorpurchase({
    super.key,
    required this.img,
    required this.title,
    required this.price,
  ...
  @override
  ConsumerState<Tandoorpurchase> createState() => _TandoorpurchaseState();
}

class _TandoorpurchaseState extends ConsumerState<Tandoorpurchase> {
