...
class Pizzapurchase extends ConsumerStatefulWidget {
  const Pizzapurchase({
    super.key,
    required this.img,
    required this.title,
  ...
  @override
  ConsumerState<Pizzapurchase> createState() => _PizzapurchaseState();
}

class _PizzapurchaseState extends ConsumerState<Pizzapurchase> {
