...
class Italypurchase extends ConsumerStatefulWidget {
  const Italypurchase({
    super.key,
    required this.img,
    required this.title,
  ...
  @override
  ConsumerState<Italypurchase> createState() => _ItalypurchaseState();
}

class _ItalypurchaseState extends ConsumerState<Italypurchase> {
