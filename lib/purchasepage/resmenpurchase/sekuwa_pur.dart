...
class Sekuwapurchase extends ConsumerStatefulWidget {
  const Sekuwapurchase({
    super.key,
    required this.img,
    required this.title,
    required this.price,
  ...
  @override
  ConsumerState<Sekuwapurchase> createState() => _SekuwapurchaseState();
}

class _SekuwapurchaseState extends ConsumerState<Sekuwapurchase> {
