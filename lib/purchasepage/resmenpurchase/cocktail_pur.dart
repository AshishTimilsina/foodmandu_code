...
class Cocktailpurchase extends ConsumerStatefulWidget {
  const Cocktailpurchase({
    super.key,
    required this.img,
    required this.title,
    required this.price,
  ...
  @override
  ConsumerState<Cocktailpurchase> createState() => _CocktailpurchaseState();
}

class _CocktailpurchaseState extends ConsumerState<Cocktailpurchase> {
